...
(defun xuyizhe-web/post-init-js-mode ()
...
(defun xuyizhe-web/post-init-js2-refactor ()
  (use-package js2-refactor))

(defun xuyizhe-web/post-init-js-jsx-mode ()
  (add-hook 'js-jsx-mode-hook 'prettier-js-mode))

(defun xuyizhe-web/post-init-js2-jsx-mode ()
...
(defun xuyizhe-web/post-init-ng2-mode ()
